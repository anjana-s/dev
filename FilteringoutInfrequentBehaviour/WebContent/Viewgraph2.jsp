...
var chart = new CanvasJS.Chart("chartContainer", {
	...
	title:{
		text: "profit as per transaction"
	},
	axisY:{
		title: " profit",
		lineColor: "#C24642",
	...
	data: [{        
		...
		dataPoints: [
		             ...
		             int i,profit;
		             String sql1="select distinct(userid) from transact ";
		             Connection con1=Db.getConnection();
		             Statement st1=con1.createStatement();
		             ResultSet rs1=st1.executeQuery(sql1);
		             while(rs1.next())
		             {i=rs1.getInt(1);
		             String sql="select sum(profit) from transact where userid='"+i+"'";
...
<div>
			   ...
			   <div class="col_1_of_list span_1_of_list login-right">
			  	<h3 style="color:purple;font-family: cursive;">GRAPH</h3>
