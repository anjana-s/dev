		...
		<div class="main">
				...
				<div class="register">
					   ...
					   <div class="col_1_of_list span_1_of_list login-right">
					  	...
					  	<ul class="nav" >
					  	  <h1>  <li style="font-size:30px;"><a href="Additem.jsp">ADD ITEMS</a></li></h1><br>
					  	  <h1>  <li style="font-size:30px;"><a href="ViewAddedItem.jsp">VIEW ITEMS</a></li></h1><br>
					  	  <h1>  <li style="font-size:30px;"><a href="Viewgraph.jsp">VIEW GRAPH</a></li></h1><br>
					  	  <h1>  <li style="font-size:30px;"><a href="Viewtransaction.jsp">TRANSACTION DETAILS</a></li></h1><br>
					  	</ul>
